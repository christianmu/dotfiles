...
BACKUP_DIR="$MOUNTPOINT/backup-nextcloudordner_$DATE"
mkdir -p "$BACKUP_DIR"

# Backup mit rsync durchführen
echo "🔁 Starte Backup des Nextcloud-Ordners (/home/chris/Nextcloud) …"
rsync -av /home/chris/Nextcloud "$BACKUP_DIR"
